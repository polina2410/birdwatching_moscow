...
export default async function AdminExpeditionsPage({ searchParams }: Props) {
  await requireAdmin()
  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <Link href="/admin/events/new" className={buttonVariants({variant: 'secondary'})}>Создать экспедицию</Link>
      </div>
